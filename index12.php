				...
				<div class="row">
					...
					<div class="col-xl-6 col-lg-5">
						<form class="header-search-form">
							<input type="text" placeholder="Search on Book Store....">
			...
			<div class="hs-item set-bg" data-setbg="img/bg-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							<span>New Arrivals</span>
							<h2>Compititive Exam</h2>
							<p>Disha's BESTSELLER "24 Years CSAT General Studies IAS Prelims and Mains Topic-wise Solved Papers (1995-2018)" consists of past years solved papers of the General Studies Paper 1 and 2 distributed into 8 Units and 52 Topics. This is the 9th edition of the book and has been thoroughly revised and updated. The book has been designed in 2 colour so as to make it more student friendly. The book also provides Essays divided topic-wise from 1993-2017.  </p>
							<a href="#" class="site-btn sb-line">DISCOVER</a>
							<a href="#" class="site-btn sb-white">ADD TO CART</a>
						</div>
					</div>
	...
	<section class="banner-section">
		<div class="container">
			<div class="banner set-bg" data-setbg="img/banner-bg.jpg">
				<div class="tag-new">NEW</div>
				<span style="visibility: hidden;">New Arrivals</span>
				<h2 style="visibility: hidden;">STRIPED SHIRTS</h2>
				<a href="#" class="site-btn" style="visibility: hidden;">SHOP NOW</a>
			</div>
		</div>
	</section>
	<!-- Banner section end  -->
