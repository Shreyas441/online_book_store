					...
					<li><a href="#">Category
						<span class="new">New</span>
							...
							<?php
										...
										$querymenu="select * from category ";
			
										$resmenu=mysqli_query($conn,$querymenu);
											
										while($rowmenu=mysqli_fetch_assoc($resmenu))
											{
												echo '<li><a href="subcat.php?cat='.$rowmenu['cat_id'].'&catnm='.$rowmenu["cat_nm"].'">'.$rowmenu["cat_nm"].'</a></li>';
