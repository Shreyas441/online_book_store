								...
								<div class="post">
									...
									<div class="entry" >
										...
										<form action="process_contact.php" method="POST">
											...
											<br>Name :<br>
												<input type='text' name='nm' size=35 required="required">
												<br><br><br>
												
												E-mail ID:<br>
												<input type='email' name='email' size=35 required="required">
												<br><br><br>
												
												Query:<br>
												<textarea cols="40" rows="10" name='query' required="required"></textarea>
												<br><br><br>
